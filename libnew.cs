        ...
        static async Task Main(string[] args)
        {
           ...
           // Console.WriteLine(s);
            try
            {
                ...
                Console.WriteLine("enter your person group id to check weather a person group id already exists or not , if not a new persongroup will be created for you ");
              ...
              //  Console.WriteLine(kkk.ToString());
                if (!kkk.Equals(null))
                {
                    Console.WriteLine("a "+persongroupID+" persongroup already exists ,do you want to use it or create another one ? reply with 'use' or 'new' ");
                    ...
                    else if (qw == "new")
                    {
                        ...
                        Console.WriteLine("what do you wwant to name this person group ? (a name is not the id)");
                        string r = Console.ReadLine();
                        await client.PersonGroup.CreateAsync(persongroupID, r);
                    }
                }
                else {
                    Console.WriteLine("what do you want to name this person group ? (a name is not the id  )");
                    string r = Console.ReadLine();
                    await client.PersonGroup.CreateAsync(persongroupID, r);
                }
